      ...
      <div class="flex flex-col">
        ...
        <div>
          ...
          <select
            ...
            class="bg-white border border-gray-300 rounded-md mx-4 shadow-sm pl-3 pr-4 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
          >
